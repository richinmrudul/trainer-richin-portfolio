  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-3">
      ...
      <input
        ...
        autoComplete="off"
        className="w-full rounded-lg border border-zinc-800 bg-zinc-950/80 px-3 py-2.5 font-sans text-sm text-zinc-200 placeholder:text-zinc-600 focus:border-rose-900/60 focus:outline-none focus:ring-1 focus:ring-rose-900/40"
      />
      <ul
        id={listId}
        role="listbox"
