    ...
    >
      ...
      >
        <button
          ...
          className="group relative flex h-full w-full flex-col overflow-hidden rounded-xl border border-zinc-800/90 bg-zinc-900/40 text-left shadow-[0_1px_0_0_rgba(255,255,255,0.04)_inset] outline-none transition-[border-color,box-shadow,transform] duration-300 ease-out hover:-translate-y-0.5 hover:border-zinc-600/80 hover:shadow-[0_18px_48px_-28px_rgba(0,0,0,0.55)] focus-visible:ring-2 focus-visible:ring-zinc-500/40 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950"
